...
<html lang="en">
  ...
  $(document).ready(function(){
    $(".Affect").click(function(){
     ...
     if(idRdv){
        window.location = 'AffichMedecins.php?idRdv=' + idRdv;
      } 
    });
            ...
            <div class="row">
                <div class="x_panel">
                  <div class="x_content">
                      ...
                      <div class="clearfix"></div>
                      <?php
                              $query="SELECT * FROM patient,rendez_vous WHERE patient.id_patient=rendez_vous.id_patient and rendez_vous.confirmer='0' and id_inf IS NULL";
                                ...
                                <div class='well profile_view'>
                                  ...
                                  <div class=' profile-bottom text-center'>
                                    <div class=' col-sm-6 emphasis'>
                                      <button type='button' class='btn btn-primary btn-sm Affect' idRdv='".$IdRdv."'>
