...
<html lang="en">
  ...
  $(document).ready(function(){
    $(".Affect").click(function(){
      ...
      var idM = $(this).attr('idM').trim();
      if(idRdv&&idM){
        window.location = 'calendarMedicen.php?idRdv=' + idRdv+"&idM="+idM;
      } 
    });
                                ...
                                <div class='well profile_view'>
                                  <div class='col-sm-12'>
                                    ...
                                    <div class='left col-md-7 col-sm-7'>
                                      ...
                                      <ul class='list-unstyled'>
                                        <li><i class='fa fa-building'></i> Email: ".$EmailM."</li>
                                        <li><i class='fa fa-building'></i> specialite: ".$specialite."</li>
                                      </ul>
                                    </div>
                                  ...
                                  <div class=' profile-bottom text-center'>
                                    <div class=' col-sm-6 emphasis'>
                                      <button type='button' class='btn btn-primary btn-sm Affect' idRdv='".$idRdv."' idM='".$idM."'>
                                        <i class='fa fa-user'> </i> Affecter RDV
                                      </button>
                                    </div>
                                  </div>
                                </div>
