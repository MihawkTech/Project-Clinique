                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <table id="datatable-checkbox" class="table table-striped table-bordered bulk_action" style="width:100%">
                      ...
                      <tbody>
                        <tr><?php
                              $query="SELECT rendez_vous.id_rdv,patient.email,patient.date_n,patient.adresse,patient.numero_tel,patient.sexe,patient.prenom,patient.nom,rendez_vous.date_rdv,rendez_vous.symptomes FROM patient,rendez_vous WHERE patient.id_patient=rendez_vous.id_patient and rendez_vous.confirmer='0' and rendez_vous.id_medecin=".$idUser;
                              ...
                              while($row=$resultat->fetch_assoc()){
                                ...
                                echo "
                                      <td>
                                        <th><input type='checkbox' id=".$IdRdv." class='confirm'></th>
                                        </td>
                                        <td>".$NameP."</td>
                                        <td>".$EmailP."</td>
                                        <td>".$NumTelP."</td>
